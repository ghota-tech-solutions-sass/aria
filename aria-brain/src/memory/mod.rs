...
//! - `persistence` - EliteDNA, Pattern, Association, Memory, etc. (serializable types)
//!
...
pub use episodic::{CompressedEpisode, Episode, EpisodeCategory, EpisodeEmotion};
pub use exploration::ExplorationResult;
pub use hierarchy::{ShortTermMemory, WorkingContent, WorkingMemory};
pub use types::SocialContext;
pub use visual::VisualMemory;

// Re-export persistence types
pub use persistence::{
    default_emission_threshold, default_learning_rate, default_response_probability,
    default_spontaneity, Association, EliteDNA, EliteStructuralCode, GlobalStats, Memory, Outcome,
    Pattern, ProtoConcept,
};

// Re-export meta_learning types for external use
pub use crate::meta_learning::{
    CurrentParams, InternalReward, MetaLearner, ModifiableParam, SelfModifier,
};
