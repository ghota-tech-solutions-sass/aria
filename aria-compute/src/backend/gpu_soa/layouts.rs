//! Bind group layout definitions for GPU SoA backend
//!
//! Defines the structure of all bind groups used by compute shaders.
...
impl GpuSoABackend {
    pub(super) fn create_bind_group_layouts(&mut self) -> AriaResult<()> {
        ...
        // Sparse cell update bind group layout
        ...
        // Signal with spatial hash bind group layout
        ...
        // Sleeping drain bind group layout
